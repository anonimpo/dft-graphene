...
# Load data from gr-aa-3L.bands.gnu - check both locations
band_file_paths = ["./reference/gr-aa-3L.bands.gnu", "./gr-aa-3L.bands.gnu"]
data = None
...
# Add title
plt.title("AA-stacked Trilayer Graphene Band Structure")
