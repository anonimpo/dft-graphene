...
# Load data from gr-aa-4L.bands.gnu - check both locations
band_file_paths = ["./reference/gr-aa-4L.bands.gnu", "./gr-aa-4L.bands.gnu"]
data = None
...
# Add title
plt.title("AA-stacked Four-Layer Graphene Band Structure")
